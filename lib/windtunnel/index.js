...
function createContext() {
  ...
  sandbox.script = function(scriptPath) {
    var filename = getCurrentScriptPath()
    var dir = path.dirname(filename)
    var fullpath = tools.realpath(path.join(dir, scriptPath))
    var data = tools.readfile(fullpath)
    var s = vm.createScript(tools.convertToJs(data, fullpath), fullpath)
...
module.exports = {
  ...
  runFile: function(filePath) {
    ...
    var realpath = tools.realpath(filePath)
